...
import com.example.fooddelivery.ui.home.DishDetails;
...
public class DishAdapter extends RecyclerView.Adapter<DishAdapter.DishViewHolder> {
    ...
    public DishAdapter(Context context, List<Dish> allmenuList) {
    ...
    public void onBindViewHolder(@NonNull DishViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, DishDetails.class);
                ...
                i.putExtra("calories", allmenuList.get(position).getCalories());
