...
import com.example.fooddelivery.ui.dashboard.DashboardFragment;
...
public class DishDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calories = intent.getStringExtra("categories");
        ...
        btFavorites.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (DishGestion.busca(name) == null){
                    if(DishGestion.insert(new Dish(name, rating, deliveryTime, price, calories))){
                        Toast.makeText(getApplicationContext(), "Dish added successfully!", Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(getApplicationContext(), "Error!", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(getApplicationContext(), "The dish is already in my favorites", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
